...
def get_guess():
    while True:
        ...
        try:
            ...
            print(ValueError("The Input Must Be A Number"))
...
def hints(number, guess, counter):
    if counter == 2:
        ...
        print(
            f"The number is between {number - randint(5, 10)} and {number + randint(5, 10)}.")
    elif counter == 4:
        print(
            f"The number is between {number - randint(1, 4)} and {number + randint(1, 4)}.")
    elif counter == 5:
        factors(number)
        print()
...
def main():
    while True:
        ...
        while choice != 'y/n':
            choice = str(input("Please enter either y/n: "))
        if choice == 'n':

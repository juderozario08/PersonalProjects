...
class MyFrame extends JFrame implements ActionListener {
    ...
    ImageIcon mainIcon = new ImageIcon("src/Images/icon.png");
    ImageIcon characterChoiceBackground = new ImageIcon("src/Images/characterChoiceButton.png");
    ImageIcon akazaImageBackground = new ImageIcon("src/Images/akazaBackground.png");
    ImageIcon muzanImageBackground = new ImageIcon("src/Images/muzanBackground.png");
    ImageIcon ruiImageBackground = new ImageIcon("src/Images/ruiBackground.png");
    ImageIcon thunderBackground = new ImageIcon("src/Images/thunderStrike.png");
    ImageIcon fireBackground = new ImageIcon("src/Images/fireBackground.png");
    ImageIcon waterBackground = new ImageIcon("src/Images/waterStrike.png");
    ImageIcon inosukeBodyImage = new ImageIcon("src/Images/inosuke.png");
    ImageIcon zenitsuBodyImage = new ImageIcon("src/Images/zenitsu.png");
    ImageIcon kamadoBodyImage = new ImageIcon("src/Images/tanjiro.png");
    ImageIcon GameOverIcon = new ImageIcon("src/Images/gameover.png");
    ImageIcon akazaBodyImage = new ImageIcon("src/Images/akaza.png");
    ImageIcon muzanBodyImage = new ImageIcon("src/Images/muzan.png");
    ImageIcon CreditsIcon = new ImageIcon("src/Images/credits.png");
    ImageIcon YouWinIcon = new ImageIcon("src/Images/youWin.png");   
    ImageIcon menuIcon = new ImageIcon("src/Images/menuBack.jpg");
    ImageIcon ruiBodyImage = new ImageIcon("src/Images/rui.png");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Heal functionalities for all slayers
            ...
            if (DemonSlayerMain.heals == 1){
                ...
                JOptionPane.showMessageDialog(null, "Health increased from "+(DemonSlayerMain.kamado.getHealth()-30)+" to "+
            ...
            if (DemonSlayerMain.heals == 1){ 
                ...
                JOptionPane.showMessageDialog(null, "Health increased from "+(DemonSlayerMain.zenitsu.getHealth()-30)+" to "+
            ...
            if (DemonSlayerMain.heals == 1){ 
                ...
                JOptionPane.showMessageDialog(null, "Health increased from "+(DemonSlayerMain.inosuke.getHealth()-30)+" to "+
        ...
        if (boss.equals("RUI")){
            ...
            timer.schedule(new TimerTask(){
                ...
                public void run() {
                    ...
                    else if (allSlayerDeath()) endGame();
                    else if (DemonSlayerMain.rui.healthRui <= 0) winGame();
                }
            },1000); 
        }
        else if (boss.equals("AKAZA")){
            ...
            timer.schedule(new TimerTask(){
                ...
                public void run() {
                    ...
                    else if (DemonSlayerMain.akaza.akazaHealth <= 0) winGame();
                }
            }, 1000);
        }
        else if (boss.equals("MUZAN")){
            ...
            timer.schedule(new TimerTask(){
                ...
                public void run() {
                    ...
                    else if (DemonSlayerMain.muzan.healthMuzan <= 0) winGame();
                }
            }, 1000);
        }
    }
